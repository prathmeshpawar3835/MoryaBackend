...
public sealed class BusinessSettingConfiguration : IEntityTypeConfiguration<BusinessSetting>
{
    public void Configure(EntityTypeBuilder<BusinessSetting> builder)
    {
        ...
        builder.Property(x => x.ReturnDeductionPercent).HasPrecision(5, 2);
        builder.Property(x => x.ExchangeDeductionPercent).HasPrecision(5, 2);
        builder.Property(x => x.BuybackDeductionPercent).HasPrecision(5, 2);
        builder.Property(x => x.WhatsAppPhoneNumberId).HasMaxLength(50);
        builder.Property(x => x.WhatsAppAccessToken).HasMaxLength(500);
        builder.Property(x => x.WhatsAppApiBaseUrl).HasMaxLength(200);
    }
}
